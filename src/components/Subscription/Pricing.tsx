...
import { Price, ProductWithPrices, SubscriptionWithProduct } from '@/types/type.stripe';
...
export default function Pricing({
  ...
  subscription
    ...
    const handleCheckout = async (price: Price) => {
        ...
        if (subscription || price.unit_amount === 0) {
        ...
        <div className='flex flex-col gap-4 items-center'>
            <Tabs defaultValue={billingInterval} className="w-[400px] self-center ">
                    ...
                    {intervals.includes('year') && (
                        <TabsTrigger onClick={() => setBillingInterval('year')} value="year">Yearly</TabsTrigger>
                    )}
                    </TabsList>
            </Tabs>
    ...
    >
        <div className="flex flex-col gap-4 p-6 h-full">
            ...
            <section className='flex flex-col gap-4'>
                ...
                <Button
                    variant={
                        subscription && product.name === subscription?.prices?.products?.name
                        ? "accent-1-enabled"
