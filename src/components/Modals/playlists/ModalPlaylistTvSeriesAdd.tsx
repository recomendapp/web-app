...
export function ModalPlaylistTvSeriesAdd({
	...
	const addToSourceOptions = usePlaylistTvSeriesAddToOptions({
	...
	// Mutations
	const { mutateAsync: addTvSeriesToPlaylist, isPending } = usePlaylistTvSeriesInsertMutation({
		tvSeriesId: tvSeriesId,
	});
	...
	}, [addTvSeriesToPlaylist, comment, closeModal, props.id, selectedPlaylists, session, t, tvSeriesId]);
