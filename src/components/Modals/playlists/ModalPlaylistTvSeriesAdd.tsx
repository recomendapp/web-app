...
export function ModalPlaylistTvSeriesAdd({
	...
	const addTvSeriesToPlaylist = usePlaylistTvSeriesInsertMutation({
		tvSeriesId: tvSeriesId,
	});
	...
	return (
		...
		>
			...
			<ModalFooter className="flex items-center p-4 sm:justify-between">
				...
				<Button
				disabled={!selectedPlaylists.length || addTvSeriesToPlaylist.isPending}
				onClick={submit}
				>
				{addTvSeriesToPlaylist.isPending && <Icons.loader className="mr-2" />}
