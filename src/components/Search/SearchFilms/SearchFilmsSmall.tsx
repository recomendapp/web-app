...
export default function SearchFilmsSmall({
  ...
  if (loading) {
    return (
      <>
        {/* XL SCREEN */}
        <div className="hidden w-full xl:grid grid-cols-1 @lg:grid-cols-2 gap-4">
          {/* MEILLEUR RESULTAT */}
  ...
  return (
    <>
      {/* XL SCREEN */}
      <div className="hidden w-full xl:grid grid-cols-1 @4xl:grid-cols-2 gap-2">
        {/* MEILLEUR RESULTAT */}
        <div className="flex flex-col gap-2">
          <div className="flex justify-between items-end">
          ...
          >
            ...
            <div className="flex flex-col justify-end">
              ...
              <div className="line-clamp-2">
                {results[0].directors.length ? (
                  results[0].directors.map(
                    (director: any, index: number) => (
                      <span key={director.id}>
                        ...
                        {index !== results[0].directors.length - 1 && (
