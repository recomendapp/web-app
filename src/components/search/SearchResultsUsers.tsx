...
export default function SearchResultsUsers({ query } : { query: string | undefined }) {
                ...
                {results?.slice(0,10).map((item) => (
                    ...
                    >
                        ...
                        <Avatar className="h-[150px] w-[150px] shadow-2xl">
                            ...
                            <AvatarFallback className="text-primary bg-background text-[50px]">{getInitiales(item.username)}</AvatarFallback>
                        </Avatar>
                        {/* NAME */}
                        <div>
                            {item.username}
