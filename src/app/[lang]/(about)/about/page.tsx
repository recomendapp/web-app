  ...
  return (
    <main className='flex flex-col gap-4 items-center text-justify transition-all'>
        ...
        <section id='team' className='w-full flex flex-col gap-4 px-4 max-w-xl'>
            <h2 className='text-center font-semibold text-3xl text-accent-1'>{t('team.label')}</h2>
            <p>
              {t('team.intro')}
            </p>
            {/* MEMBERS */}
        ...
        <section id='pricing' className='w-full flex flex-col gap-4 px-4 max-w-xl'>
          <h2 className='text-center font-semibold text-3xl text-accent-1'>{t('pricing.label')}</h2>
          <p>
            {t('pricing.intro')}
          </p>
          <Pricing
        ...
        <section id='businessmodel' className='w-full flex flex-col gap-4 px-4 max-w-xl'>
            <h2 className='text-center font-semibold text-3xl text-accent-1'>{t('businessmodel.label')}</h2>
            <p>
              {t('businessmodel.paragraph.1')}
            </p>
            <p>
              {t('businessmodel.paragraph.2')}
            </p>
            <p>
              {t('businessmodel.paragraph.3')}
            </p>
            <p>
              {t('businessmodel.paragraph.4')}
            </p>
        </section>
        {/* ROADMAP */}
        <section id='roadmap' className='w-full flex flex-col gap-4 px-4 max-w-xl'>
            <h2 className='text-center font-semibold text-3xl text-accent-1'>{t('roadmap.label')}</h2>
        ...
        <section id='data' className='w-full flex flex-col gap-4 px-4 max-w-xl'>
            <h2 className='text-center font-semibold text-3xl text-accent-1'>{t('data.label')}</h2>
            <p>
              {t.rich('data.paragraph.1', {
                link: (chunks) => <Link href='https://www.themoviedb.org/' target='_blank' className='transition-colors underline underline-offset-2 hover:text-accent-pink'>{chunks}</Link>
              })}
            </p>
            <p>
        ...
        {/* RESSOURCES */}
        <section id='ressources' className='w-full flex flex-col gap-4 px-4 max-w-xl'>
            <h2 className='text-center font-semibold text-3xl text-accent-1'>{t('ressources.label')}</h2>
            <p>
              {t('ressources.intro')}
            </p>
            <ul className='space-y-2 list-disc'>
              {ressources.map((ressource, index) => (
                <li key={index}>
                  <Link href={ressource.link} target='_blank' className='transition-colors underline underline-offset-2 hover:text-accent-pink'>{ressource.name}</Link>
                </li>
              ))}
            </ul>
        </section>
        ...
        <section id='contact-support' className='w-full flex flex-col gap-4 px-4 max-w-xl'>
            <h2 className='text-center font-semibold text-3xl text-accent-1'>{t('contact-support.label')}</h2>
            <p>
              {t.rich('contact-support.help-center', {
                link: (chunks) => <Link href='https://help.recomend.app/' target='_blank' className='transition-colors underline underline-offset-2 hover:text-accent-pink'>{chunks}</Link>
              })}
            </p>
            <p>
              {t.rich('contact-support.technical-support', {
                link: (chunks) => <Link href='mailto:help@recomend.app' className='transition-colors underline underline-offset-2 hover:text-accent-pink'>{chunks}</Link>
              })}
            </p>
            <p>
              {t.rich('contact-support.suggest-a-feature', {
                link: (chunks) => <Link href='mailto:ideas@recomend.app' className='transition-colors underline underline-offset-2 hover:text-accent-pink'>{chunks}</Link>
              })}
            </p>
            <p>
              {t.rich('contact-support.conact-us', {
                link: (chunks) => <Link href='mailto:contact@recomend.app' className='transition-colors underline underline-offset-2 hover:text-accent-pink'>{chunks}</Link>
              })}
            </p>
        </section>
        {/* QUOTE */}
        <section id='quote' className='w-full flex flex-col gap-4 px-4 max-w-xl mt-5 py-8'>
          <blockquote className="relative">
            <svg className="absolute -top-6 -start-5 h-12 w-12 text-muted" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
